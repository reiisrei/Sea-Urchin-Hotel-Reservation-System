  				...
  				<div class="col-lg-12"><!-- Room Gallery Slider -->
  					<div class="room-gallery">
  						...
  						<div class="flexslider-thumb falsenav">
  							<ul class="slides">
  								<li data-thumb="theme/theme/temp/room-gallery-image-1.jpg"><img alt="Slider 1" class="img-responsive" src="theme/temp/room-gallery-image-1.jpg"/></li>
