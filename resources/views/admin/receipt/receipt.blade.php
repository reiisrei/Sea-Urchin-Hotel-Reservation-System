                                    ...
                                    <table cellpadding="0" cellspacing="0" border="0" width="47%" style="width: 47%;" align="right">
                                        <tr>
                                            <td>
                                                <table cellpadding="0" cellspacing="0" border="0" width="100%">
                                                    <tr>
                                                        <td align="right" style="font-family: Arial, sans-serif; color: #7ca230; font-size: 16px; font-weight: bold;">&#8369; {{ number_format((($totalRoomPrice + ($totalRoomPrice * .12)) + ($booking->payment->damages + $booking->payment->amenitiesCharges + $booking->payment->bedSheet + $booking->payment->pillow + $booking->payment->towel)) - ($booking->payment->discount / 100) * (($totalRoomPrice + ($totalRoomPrice * .12)) + ($booking->payment->damages + $booking->payment->amenitiesCharges + $booking->payment->bedSheet + $booking->payment->pillow + $booking->payment->towel)),2) }}</td>
                                                    </tr>
                                                </table>
                                            </td>
                                        </tr>
